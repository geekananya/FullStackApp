...
const CreatePost = () => {
    ...
    async function handleSubmit (event) {
        ...
        try{
          ...
          const resp = await axios.post("/api/posts/create", formdata)
    ...
    return (
        ...
        >
            ...
            >
                <h1 className="text-2xl mb-3 mt-3 text-center">Create a New Post</h1>
                {errorMessage ? <p className='text-center text-red-500 light text-base m-0 mb-2'>{errorMessage}</p>: <div></div>}
                <div className='flex justify-end items-start'>
                    <Link to='/dashboard/posts'><img src={'close'} alt='close' 
                            width={40} height={40} 
